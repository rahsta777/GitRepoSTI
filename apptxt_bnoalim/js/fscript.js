...
//	--------------------------------------
function registro_compra_actividad_economica_excel(form, nombre_archivo) {
	//	formulario
	var post = "";
	var error = "";
	for(var i=0; n=form.elements[i]; i++) {
	...
	//	abrir archivo
	window.open("ap_registro_compra_actividad_economica_excel.php?nombre_archivo="+nombre_archivo+"&"+post, "ap_registro_compra_actividad_economica_excel", "toolbar=no, menubar=no, location=no, scrollbars=yes, height=100, width=100, left=500, top=500, resizable=yes");
}