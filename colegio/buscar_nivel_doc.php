...
function consulta_ajax()
 {
    	...
    	//var var1=(document.getElementById("tip_bus").value);
...
xmlhttp.open("GET","localizar_nivel_doc.php?var1="+var1,true);
xmlhttp.send();
}
	}
...
<div class="pweb" class="center"><!--pweb -->
        <form action="menu.php" method="POST" >
                                    <div id="box_reg" style="font-size:14px;">
                                        ...
                                        <strong>Buscar Cedula:</strong><input type="text"  name="buscar" id="buscar" size="10" style="background:url(images/fondo_input/fondo_input.png);width:100px;height:30px ;" onkeyup="consulta_ajax()">
                                        <!--select name="tip_bus" id="tip_bus" >
                                              <option value="doc">Docente</option>
                                              <option value="alumn">Alumnos</option>
