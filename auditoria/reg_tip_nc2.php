...
// Conexión a la base de datos
	...
	if (isset($_POST["num_tipncx1"]) and($_POST["tip_nc_desc"]!="")) 
		{
			//------------------------ Datos de Entrada 
			$num_reqx=$_POST['num_tipncx1'];
			$nomb_reqy=$_POST['tip_nc_desc'];
		//echo $num_reqx."/".$nomb_reqy;
           
          
		
		
	if (mysql_num_rows(mysql_query("SELECT num_tip_nc FROM  j009t_tipo_nc WHERE num_tip_nc	='" . $_POST['num_tipncx1'] . "'", $link))==0) {
   	$query="insert into j009t_tipo_nc (num_tip_nc, descr_nc) VALUES ('$num_reqx','$nomb_reqy')";
