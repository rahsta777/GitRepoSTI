...
// Conexión a la base de datos
	...
	if (isset($_POST["ced_prop"]) and($_POST["prop_desc"]!="")) 
		{
			//------------------------ Datos de Entrada 
			$numx=$_POST['ced_prop'];
			$nombx=$_POST['prop_desc'];
		
            
          
		
		
	if (mysql_num_rows(mysql_query("SELECT num_ced_proponente 	FROM j008t_ced_proponente WHERE 	num_ced_proponente 		='" . $_POST['ced_prop'] . "'", $link))==0) {
   	$query="insert into  j008t_ced_proponente (num_ced_proponente , descri_proponente) VALUES ('$numx','$nombx')";
