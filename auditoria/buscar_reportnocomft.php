   ...
   if (isset($_SESSION["usuario_valido"]))
			...
			?>
                           ...
                           <div  style="font-size:14px;">
                                      <strong>Buscar:</strong><input type="text"  name="buscareport" id="buscareport" size="10" style="background:url(images/fondo_input/fondo_input.png);width:100px;height:30px ;" onkeyup="reporte1_ajax()">
								                         <div style="width:20%">       																			              																			
