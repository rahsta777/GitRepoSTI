...
// Conexión a la base de datos
	...
	if (isset($_POST["rol_desc"]) and($_POST["num_rol"]!="")) 
		{
			//------------------------ Datos de Entrada 
			$num_rolx=$_POST['num_rol'];
                         /*echo("clave:"."").$clv_y;*/
			$nomb_roly=$_POST['rol_desc'];
		
            
          
		
		
	if (mysql_num_rows(mysql_query("SELECT 	num_rol FROM  j001t_roles   WHERE 	num_rol	='" . $_POST['num_rol'] . "'", $link))==0) {
   	$query="insert into j001t_roles (num_rol,descrp_rol) VALUES ('$num_rolx','$nomb_roly')";
