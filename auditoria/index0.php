...
<p><a href="cerrar_session.php" title="Cerrar sesión"><img src="images/cerrarsession.png" alt="" width="30" height="30" border="0" align="right"></a></p> 
<p><a href="acceso.php"><img src="images/PNG/Login.png" title="Login" width="30" height="30" border="0" align="right"></a></p> 
 <p><a href="javascript:close();"><img src="images/Exit.png" title="Salir" width="30" height="30" border="0" align="right"></a></p> 
    </div><!--**************fin id barra1**************** -->
<div id="fila" >
<div  id="box1">
<!-- *********************************Menu Principal****************************** -->
...
<div class="dropMenu" ><!-- -->
	...
	<div class="subMenu" style="display:none;">
    <div class="subItem"><a href="#" onmouseover="visible('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4'); blendoff('contaud5'); blendoff('contaud6'); blendoff('contaud7'); blendoff('contaud8'); blendoff('contaud9'); oculta('contenido0'); oculta('contenido1'); oculta('contenido2'); oculta('contenido3');oculta('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); ; blendoff('report00'); blendoff('report01');" onclick="return false;" >Datos Auditorias</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contaud1'); blendoff('contaud0'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4'); blendoff('contaud5'); blendoff('contaud6'); blendoff('contaud7'); blendoff('contaud8'); blendoff('contaud9'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contenido4'); blendoff('contmant0');blendoff('contmant1'); ; blendoff('report00'); blendoff('report01');"  onclick="return false;" >Auditorias</a></div>
    ...
    <div class="subItem"><a href="#" onmouseover="visible('contaud3'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud4'); oculta('contaud5'); oculta('contaud6'); oculta('contaud7'); oculta('contaud8'); oculta('contaud9'); oculta('contenido0');oculta('contenido1'); oculta('contenido2');oculta('contenido3'); oculta('contenido4'); oculta('report00'); blendoff('contmant0');blendoff('contmant1'); ; blendoff('report00'); blendoff('report01');"  onclick="return false;">Plan</a></div>
    <!--div class="subItem"><a href="#" onmouseover="visible('contaud4'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud5');blendoff('contaud6');blendoff('contaud7');blendoff('contaud8');blendoff('contaud9');blendoff('contenido0');blendoff('contenido1'); blendoff('contenido2');blendoff('contenido3'); blendoff('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); blendoff('report00'); blendoff('report01');"  onclick="return false;" >Hallazgo</a></div-->
    ...
    <div class="subItem"><a href="#" onmouseover="visible('contaud6');blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4');blendoff('contaud5');blendoff('contaud7');blendoff('contaud8');blendoff('contaud9');blendoff('contenido0'); blendoff('contenido1');blendoff('contenido2');blendoff('contenido3'); blendoff('contenido4');oculta('report00'); blendoff('contmant0'); blendoff('contmant1');blendoff('report01');"  onclick="return false;" >NoConformidad</a></div>
    <!--div class="subItem"><a href="#" onmouseover="visible('contaud7'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4');blendoff('contaud5');blendoff('contaud6');blendoff('contaud8');blendoff('contaud9');blendoff('contenido0'); blendoff('contenido1');blendoff('contenido2');blendoff('contenido3'); blendoff('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); blendoff('report01');"  onclick="return false;" >Declaracion/Acciones</a></div-->
    <div class="subItem"><a href="#" onmouseover="visible('contaud8'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4');blendoff('contaud5');blendoff('contaud6');blendoff('contaud7');blendoff('contaud9');blendoff('contenido0'); blendoff('contenido1');blendoff('contenido2');blendoff('contenido3'); blendoff('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); blendoff('report01') ;"  onclick="return false;" >Plan Accion Corrct</a></div>
...
<div class="dropMenu" >
	<div class="subMenu" style="display:none;">
		...
		<div class="subItem"><a href="#" onmouseover="visible('report02'); oculta('report00');oculta('report01'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4'); blendoff('contaud5'); blendoff('contaud6'); blendoff('contaud7'); blendoff('contaud8'); blendoff('contaud9'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contenido4');" onclick="return false;" >Acciones Correc/Prevent.</a></div>
...
<fieldset>
  	...
  	<dl>
<div id="tabs">
					<ul id="countrytabs13" class="shadetabs" >

							<li><a href="#" rel="#default" class="selected">Informacion</a></li>
							<li><a href="reg_accicorrprev.php" rel="countrycontainer">Acciones Correc/Prevent.</a></li>
							<li><a href="consu_accprev.php" rel="countrycontainer">Consulta</a></li>
							<!--li><a href="requeriente_nocon.php" rel="countrycontainer">Requiriente</a></li-->
       <!--li><a href="reg_evaluadr_audit.php" rel="countrycontainer">Reg. Evaluador</a></li-->                    
					</ul>
	<div id="countrydivcontainer13" style="padding:5px;background:white url(fondo_input.gif) top left repeat-x;border-radius:10px 50px 10px 50px;width:100%; ">
    <p>Este módulo permite el registro de las Tablas básicas</p>
 </div>
</div>
	     ...
	     <dl>
              <div id="tabs">
            		<ul id="report02tabs" class="shadetabs" >
                		  <li><a href="#" rel="#default" class="selected">Informacion</a></li>
                   	      <li><a href="buscar_report_acc.php" rel="countrycontainer">Acciones Corr/Prev.</a></li>
                          <!--li><a href="reg_rol_audit.php" rel="countrycontainer">otro</a></li>
                          <li><a href="reg_unit_audit.php" rel="countrycontainer">Disponible</a></li>
                		  <li><a href="reg_cargo_audit.php" rel="countrycontainer">Disponible</a></li-->
            		 </ul>
