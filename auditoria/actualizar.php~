...
if(isset($_POST["ced_act"])){
 ...
 //echo "Cedula doc: ".$ced_x." Tipo: ".$localiza_x." la Consulta".$localiza_x2." Proceso".$proceso;
								...
								<table class="contacto"  id="dato"   >  
                                      <tr>  <div><td><p>C&eacute;dula:
                                        <td><input type="text" id="cedx" name="cedx" value="<?php echo $ced_alum;  ?>"   size="15" onchange="cedula_val()" />
                                         ...
                                         <div  class="imgclase" id="aline_imagen"><img src="<?php echo $localiza_imagen;?>" width ="80" height="115"/></div><tr><td><p>Foto Nueva</td><td><input type="file"  id="fotoact" name="fotoact" value="<?php echo $localiza_imagen;?>" /></td></tr> 
                                       ...
                                       <tr>  <div><td><p>Nombres  :
                                        ...
                                        <td><input type="text" name="apell" size="3" id="apell"  value="<?php echo 	$apell;?>" onchange="palabras2()" /> 
                                        </p></div>
                                      ...
                                      <tr>   <div><td> <p>Tel&eacute;fono:
                                        <td><input type="text" name="telef" id="telefono" size="27" value="<?php echo $tlf;?>"/>
                                         ...
                                         <tr>   <div><td> <p>Domicilio Res.:
                                        <td><input  type="text"  name="domici" id="domici" size="27" value="<?php echo $direcc;?>"/>
                                        </p></div>
                                        
                                         <tr>   <div><td> <p>Nacionalidad:
                                        <td><input  type="text"  name="nacionalzcion" id="nacionalzcion" size="27" value="<?php echo $nacionazcion ;?>"/>
                                        ...
                                        <td><input type="text" name="correo" id="correo"  value="<?php echo $correo;?>" onchange="VerifyEmail();"/>
                                            ...
                                            <div>
                                       		  <div  style="alignment-baseline: central;">
                                       		       <input  type="submit"  value="Actualizar" name="guarda"  style="background:url(images/fondo_input/fondo_input_g.png);width:100px;height:30px ;"></a>
