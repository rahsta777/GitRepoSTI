...
<link rel="stylesheet" type="text/css" media="all" href="css/niceforms-default.css" />
	...
	<body>
    <div id="sombra">Pagina principal</div> 
 <!--=========================================================================================-->        
  <?php 
...
/*======================================================[ programacion ]========================================*/
   if($localiza_x=="programacion"){
            $busqueda0="SELECT * FROM user_audit WHERE cod_emplea_user='" . $id_x . "' AND num_detall_program = '" . $id_x1 . "' ";
      	...
      	while($filas0=mysql_fetch_array($resultquery0))        
            {
                ...
                $gerencia0=$filas0['num_gerencia'];	
       	        $unidad0=$filas0['num_unidad'];
          ...
          if (isset($numcargo0)){
            $sqlCargos="SELECT * FROM user_audit WHERE num_cargos='" . $numcargo0 . "' ";
...
?>
<!--div id="sombra"-->
<form action="reg_act_audit.php" method="post" >
		...
		<fieldset>
        	...
        	<dl>
			 <dt><div>Numero de Detalle Programacion:</div></dt>
                <dd><input type="text" name="num_detall_prog" id="num_unit" value="<?php echo  $id; ?>" size="20px"/></dd>
			</dl>
...
<dd><input type="text" name="num_grcia_prog" id="num_grcia_prog" value="<?php echo $gerencia0 ; ?>"  /></dd>			    


<dt><div>N&uacutemero de Unidad:</div></dt>
<dd><input type="text" name="num_unid_prog" id="num_unid_prog" value="<?php echo $unidad0; ?>"  /></dd>			    
...
<dt><div>Fecha Detalle:</div></dt>
            ...
            <input type="hidden" name="tipo_audit" value="<?php echo $localiza_x; ?>" />
		     <input type="submit" name="programacion" id="submit" value="Enviar" />
<?php 
...
<?php       
    ...
    <dl>
            ...
            <fieldset class="action">
            <input type="hidden" name="tipo_audit" value="<?php echo $localiza_x; ?>" />
		     <input type="submit" name="auditoria" id="submit" value="Enviar" />
             <?php 
		         print (" <P id='contacto' ALIGN='CENTER'> <A HREF='index0.php' TARGET='_top'> <input type='button' style='background:url(images/fondo_input/fondo_input_g.png);' value='[Ir Home]' ></A> </P>\n");
		    ?>
		    </fieldset>
        ...
        $resultquery3=mysql_query($busqueda3);
      	...
      	while($filas=mysql_fetch_array($resultquery3))        
            {	
							...
							//echo "Plan id:[".$id."]";
							//echo "Descrip :[".$descrip1."]";
                            $fech_audit_noconfomd=$filas['fech_audit_noconfom'];
                             $num_ced_proponented=$filas['num_ced_proponente'];
                             $text_estdod=$filas['text_estdo'];
                             $text_descripd=$filas['text_descrip'];
                             $text_clasificaciond=$filas['text_clasificacion'];
                             $text_tipificaciond=$filas['text_tipificacion'];
                             $text_tipo_ncd=$filas['text_tipo_nc'];
                             $num_inidad_nocofor_d=$filas['num_inidad_nocofor'];
                             $num_requierentd=$filas['num_requierent'];
                             $text_recomendaciond=$filas['text_recomendacion'];
                             $num_ced_evaluadord=$filas['num_ced_evaluador'];
...
<div id="caja1" style="width:400px;" > 
 ...
 <dd><input type="text" name="num_audit_noconfor" id="cod_audnoconfr"  value="<?php echo $id; ?>"/></dd>
			</dl>
    <dl>
			 <dt><div>Fecha: </div></dt>
			    <dd><input type="text" name="fecha_desc" id="fecha3" class="fecha1" value="<?php echo $fech_audit_noconfomd; ?>"/></dd>
			 </dl>
    <dl>
			 <dt><div>Cedula Proponente:</div></dt>
                 ...
                 <?php
                                $xnomb_prop=$row["nom_personal"];        }
                                    ?>
<option selected><?php echo $num_ced_proponented; ?></select>
                                    </select>
      ...
      <dl>
			 ...
			 <dt><div>Tipo de No Conformidad:</div></dt>
                 ...
                 <?php
                                    ...
                                    ?>
									<option selected><?php echo $$text_tipo_ncd; ?> </select>
                                    </select>
			   </dd>
			</dl>
            <dl>
			 <dt><div>Descripcion:</div></dt>
                <dd><input type="text" name="descrip_noconfr" id="descrip_noconfr" size="10" value="<?php echo $descrip1; ?>" /></dd>
			</dl>
            <dl>
			 <dt><div>Clasificacion:</div></dt>
			    <dd><input type="text" name="clasifi_noconfor" id="clasifi_noconfor" size="25" maxlength="128" value="<?php echo $text_clasificaciond; ?>" /></dd>
			</dl>
            <dl>
			 <dt><div>Tificacion:</div></dt>
                <dd><input type="text" name="num_tipificnoconfr" id="num_rol" size="10" value="<?php echo $text_tipificaciond; ?>"  /></dd>
			</dl>
            <dl>
...
<dd> <?php       	 
                                    ...
                                    ?>
<option selected><?php echo $num_inidad_nocofor_d; ?> </select>
                                    </select>
			   </dd>
            ...
            <dl>
			 <dt><div>Numero de Requierente:</div></dt>
                 ...
                 <?php
                                    ...
                                    ?>
				<option selected><?php echo $num_requierentd; ?> </select>
                                    </select>
			   </dd> 
            ...
            <dl>
			 <dt><div>Recomendaciones:</div></dt>
			    <dd><input type="text" name="recomendaciones" id="desc_noconfr" size="25" maxlength="128" value="<?php echo $text_recomendaciond; ?>" /></dd>
			</dl>
            <dl>
			 <dt><div>Numero de No Conformidad:</div></dt>
                <dd><input type="text" name="num_noconfr" id="num_rol" size="10"  value="<?php echo $d; ?>"/></dd>
			</dl>
            <dl>
...
<?php    	$cursor4 ="SELECT * from j004t_ced_evaluador";
                 ...
                 <?php
                                    ...
                                    ?>
<option selected><?php echo $num_ced_evaluadord; ?> </select>
                                    </select>
