...
<script>
function Procesoquery_user(valor1){
        var parametros1 = {
                "var1" : valor1 /*,
        ...
        $.ajax({
                data:  parametros1,
                url:   'localizar_user_mant.php',
                type:  'post',
                beforeSend: function () {
                        $("#la_consulta_user").html("Procesando, espere por favor...");
                },
                success:  function (response) {
                        $("#la_consulta_user").html(response);
                }
        });
}
</script>
   ...
   if (isset($_SESSION["usuario_valido"]))
			...
			?>
                           ...
                           <div  style="font-size:14px;">
                                            ...
                                            <strong>Buscar:</strong><input type="text"  name="buscaruser" id="buscaruser" size="25" style="background:url(images/fondo_input/fondo_input.png);width:150px;height:30px ;" onkeyup="Procesoquery_user($('#buscaruser').val());return false;">
																																	</div>
  	      																								<div id="la_consulta_user"></div>
     </div>       
