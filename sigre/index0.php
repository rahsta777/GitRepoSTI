...
#titul {padding:5px;float:left; font-family: "ghostclanexpand", sans-serif,bold;font-size:17px;color: #0C0F66;text-shadow: white 0.1em 0.1em 0.2em;}
#subtitl {padding:5px;float:left; font-family: "ghostclanexpand", sans-serif,bold;font-size:17px;color: #1C23F5;text-shadow: white 0.1em 0.1em 0.2em}
</style>
...
<!---=========================ventanas windows open===========================================-->
<script language="JavaScript">
function newWin() {
    var idprove=document.getElementById('idprov').value;
    var url="edit_provee.php?vari="+idprove; 
    msgWindow=window.open(url,"OpenWindow",
"width=550,height=500,scrollbars=no");
//alert("id que se va a pasar "+idprove);
}

function win_comprobar(id) {
      //alert("id que llega al openwin es:["+id+"]");
    var url="reportes/rep_comprobante.php?varid="+id; 
    msgWindow=window.open(url,"OpenWindow",
"width=1000,height=500,scrollbars=no");

}
function win_comprobar2(idavis) {
      //alert("id que llega al openwin es:["+idavis+"]");
    var url="reportes/rep_aviso_pago.php?varidavis="+idavis; 
    msgWindow=window.open(url,"OpenWindow",
"width=1000,height=500,scrollbars=no");

}

function win_actualiza_fact(idfa) {
      //alert("id que llega al openwin es:["+id+"]");
    var url="edit_fact.php?varidfa="+idfa; 
    msgWindow=window.open(url,"OpenWindow",
"width=1000,height=500,scrollbars=no");

}
function win_Act_user(iduseract) {
      //alert("id que llega al openwin es:["+iduseract+"]");
    var url="edit_user.php?variduseract="+iduseract; 
    msgWindow=window.open(url,"OpenWindow",
"width=1000,height=500,scrollbars=no");
...
function win_procesar_fact(fechid2) {
      //alert("id que llega al openwin es:["+id+"]");
    var url="Reg_procesa_fact.php?varreg_procesa="+fechid2; 
    msgWindow=window.open(url,"OpenWindow",
"width=1000,height=500,scrollbars=no");
...
<div id="barra1">
    ...
    <div id="b3"><img  id="b1" src="images/Profile.png" width="23px" ><p id="titul" style="margin-right:5px;">Usuario:</p><p id="subtitl" style="margin-right:10px;"><?PHP echo $usuario_actual; ?></p>
    <p id="titul" style="margin-right:5px;">Acceso:  </p><p id="subtitl" style="margin-right:5px;"><?PHP echo $tipo_user;?></p></div>
...
<div class="subItem"><a href="#" onmouseover="blendon('contenido0'); blendoff('contenido1'); blendoff('contaud0');   blendoff('contaud1'); blendoff('procesar0'); blendoff('contmant0'); blendoff('contmant1'); blendoff('contmant2');blendoff('report00'); blendoff('report01'); blendoff('report02');  "  onclick="return false;" >USUARIOS</a></div>
<div class="subItem"><a href="#" onmouseover="blendon('contenido1'); blendoff('contenido0'); blendoff('contaud0'); blendoff('contaud1'); blendoff('procesar0'); blendoff('contmant0'); blendoff('contmant1'); blendoff('contmant2'); blendoff('report00'); blendoff('report01'); blendoff('report02');"  onclick="return false;" >PERFILES</a></div>
...
<div class="dropMenu" ><!-- -->
	...
	<div class="subMenu" style="display:none;">
    <div class="subItem"><a href="#" onmouseover="visible('contaud0'); oculta('contaud1'); oculta('contenido0'); oculta('contenido1');  oculta('procesar0'); oculta('contmant0'); oculta('contmant1'); oculta('contmant2'); oculta('report00'); oculta('report01'); oculta('report02');" onclick="return false;" >PROVEEDORES</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contaud1'); blendoff('contaud0'); blendoff('contenido0'); blendoff('contenido1'); blendoff('procesar0'); blendoff('contmant0'); blendoff('contmant1');  blendoff('contmant2'); blendoff('report00'); blendoff('report01'); blendoff('report02'); "  onclick="return false;" >FACTURAS</a></div>
  </div>
</div>
</div>
...
<div class="dropMenu" >
<div class="subMenu" style="display:none;">
    <div class="subItem"><a href="#" onmouseover="visible('contmant0'); blendoff('contmant1'); blendoff('contmant2');blendoff('procesar0'); blendoff('contenido0'); blendoff('contenido1');  oculta('contaud0'); oculta('contaud1'); blendoff('report00'); blendoff('report01'); blendoff('report02'); " onclick="return false;" >USUARIO</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contmant1'); blendoff('contmant0'); blendoff('contmant2');blendoff('procesar0'); blendoff('contenido0'); blendoff('contenido1');  oculta('contaud0'); oculta('contaud1'); oculta('report01'); blendoff('report00'); blendoff('report02'); "  onclick="return false;" >PROVEEDORES</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contmant2'); blendoff('contmant1'); blendoff('contaud0'); blendoff('procesar0'); blendoff('contmant0'); blendoff('contaud1'); blendoff('contenido0'); blendoff('report00'); blendoff('report01'); blendoff('report02');" onclick="return false;" >FACTURAS</a></div>
</div>
</div>
</div>
<?php } ?>
...
<div class="dropMenu" ><!-- -->
  ...
  <div class="subItem"><a href="#" onmouseover="visible('procesar0'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contenido0'); blendoff('contenido1'); oculta('report00'); blendoff('contmant0'); blendoff('contmant1'); blendoff('contmant2'); blendoff('report00'); blendoff('report01');  blendoff('report02');" onclick="return false;" >FACTURA/PROV.</a></div>
...
<div class="dropMenu" ><!-- -->
	   <div class="subMenu" style="display:none;">
    <div class="subItem"><a href="../reportes/rep_useraudit.php" onmouseover="visible('report00'); oculta('report01'); oculta('contenido0'); oculta('contenido1'); oculta('contenido2'); oculta('contaud0'); blendoff('contaud1'); blendoff('contenido0'); blendoff('contenido1'); blendoff('procesar0'); " onclick="return false;" >Reporte de Usuarios</a></div> 
...
<div class="dropMenu" >
	<div class="subMenu" style="display:none;">
		<div class="subItem"><a href="#" onmouseover="visible('report01'); oculta('report00'); oculta('report02'); oculta('contenido0'); oculta('contenido1'); oculta('contaud0'); oculta('contaud1'); oculta('procesar0') ;" onclick="return false;" >Comprabante/Aviso de Pago</a></div>
...
<fieldset>
		     <legend ><img src="images/iconos/fact2.png" width="30px">Proveedores</legend>
               ...
               <div id="tabs1">
                ...
                <li><a href="cons_provee.php" >Listado Prov.</a></li>
                 <li><a href="regdifinir_retenc.php"  >Definir Ret. </a></li>
                 <li><a href="cons_retenciones.php" >Listado Ret.</a></li>
                      <?php } ?>
                      
                      <li><a href="citas.php" >Cita Proveedor</a></li>
                      <li><a href="citas2.php" >listado de Citas</a></li>
					       </ul>
...
<dl>
	<div id="tabs2">
					<ul> <?php if ($tipo_user == "administrador"){ ?>
                            ...
                            <?php } ?>
							<li><a href="cons_fact0pag.php" >Consulta</a></li>          
					</ul>
...
<fieldset>
		     <legend ><img src="images/iconos/mantenimiento.PNG" width="30px">Mant. Usuario</legend>
		
            	<dl>

                <div id="tabs3">
		        <ul>
                <li><a href="buscar_user_mant.php" >Mant. Inteligente</a></li>
   	            <li><a href="delete_user.php" >Eliminar</a></li>
					</ul>
...
<fieldset>
		     <legend ><img src="images/iconos/mantenimiento_prov.png" width="30px">Mant. Proveedores</legend>
         	...
         	<dl>
        	  ...
        	  <ul  >
           	     ...
           	     <li><a href="buscar_prov_mant.php" >Proveedor</a></li>
                 <li><a href="delete_user.php" >Eliminar</a></li>
                 <!--li><a href="buscap" >Disponible</a></li-->
...
<fieldset>
         <legend ><img src="images/iconos/mantenimiento.PNG " width="30px">Mant.Factura</legend>
          ...
          <dl>
            ...
            <ul>
                 ...
                 <li><a href="buscar_fact_mant.php" >Facturas </a></li>
...
<!--==============================================Modulo de menu procesar Faturas================================-->
  <div class="contenido"  id="procesar0">
<fieldset>
         <legend ><img src="images/iconos/fact3.jpeg" width="30px">Procesar Factura</legend>
          ...
          <dl>
            ...
            <ul  >
                 ...
                 <li><a href="buscar_procesar_fact.php" >Facturas a Procesar</a></li>
                <li><a href="buscar_fact_procesadas.php" >Facturas Procesadas</a></li>
...
<div  class="contenido" id="report01">
		 <fieldset>
		     <legend ><img src="images/Icono_Reporte.jpg" width="30px">Reportes facturas</legend>
	     ...
	     <dl>
              <div id="tabs7">
                 ...
                 <li><a href="buscar_comprabante_fact.php" >Comprobante y Avisos de Pagos</a></li>
