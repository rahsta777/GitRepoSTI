   ...
   if (isset($_SESSION["usuario_valido"]))
			...
			?>
                           ...
                           <div  style="font-size:14px;">
                                            ...
                                            <strong>Buscar:</strong><input type="text"  name="buscar" id="buscar" size="25" style="background:url(images/fondo_input/fondo_input.png);width:150px;height:30px ;" onkeyup="Procesoquery_user($('#buscar').val());return false;">
																																	</div>
