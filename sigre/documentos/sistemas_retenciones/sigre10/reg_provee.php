...
<form action="reg_provee2.php" method="post" >
		...
		<dl>
			 <dt><div>Rif:</div></dt>
			    <dd><input type="text" name="prove_rif" id="prove_rif" size="25" maxlength="128" /></dd>
			</dl>
        	<dl>
			...
			<dl>
			 <dt><div>Tlf. Contacto:</div></dt>
			    ...
			    <dd><input type="text" name="prove_contact" id="nomb_user" size="25" maxlength="128" /></dd>
			     
			</dl>
			<dl>
			 <dt><div>Email</div></dt>
			    
			    <dd><input type="text" name="prove_correo" id="nomb_user" size="25" maxlength="128" /></dd>
