...
<script type="text/javascript" type="text/javascript" src="js/niceforms.js"></script-->
...
<select name="opcion" class="contacto_opcion" onchange="getComboA(this)">
                    <option  value="general">GENERAR</option>
...
<div class="subItem"><a href="#" onmouseover="blendon('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); oculta('contaud0');   oculta('contaud1'); oculta('contaud2'); oculta('contaud3'); oculta('report00');blendoff('report01'); oculta('contmant0'); oculta('contmant1'); blendoff('contmant2'); blendoff('contmant3'); "  onclick="return false;" >USUARIOS</a></div>
<div class="subItem"><a href="#" onmouseover="blendon('contenido1'); blendoff('contenido0'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2');blendoff('contaud3'); blendoff('contmant0'); blendoff('contmant1'); blendoff('contmant2'); blendoff('contmant3'); blendoff('report00'); blendoff('report01');"  onclick="return false;" >PERFILES</a></div>
...
<div class="dropMenu" ><!-- -->
	...
	<div class="subMenu" style="display:none;">
    <div class="subItem"><a href="#" onmouseover="visible('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contenido0'); blendoff('contenido1'); oculta('contenido2'); oculta('contenido3');oculta('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); blendoff('report00'); blendoff('report01');" onclick="return false;" >PROVEEDORES</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contaud1'); blendoff('contaud0'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contenido4'); blendoff('contmant0');blendoff('contmant1'); blendoff('report00'); blendoff('report01');"  onclick="return false;" >FACTURAS</a></div>
    <!--<div class="subItem"><a href="#" onmouseover="visible('contaud2'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud3'); blendoff('contaud4'); blendoff('contaud5'); blendoff('contaud6'); blendoff('contaud7'); ;blendoff('contaud8');blendoff('contaud9'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contenido4'); oculta('report00'); blendoff('contmant0');blendoff('contmant1'); ; blendoff('report00'); blendoff('report01');"  onclick="return false;" >Programaci&oacute;n</a></div>
    <!---div class="subItem"><a href="#" onmouseover="visible('contaud9'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4');blendoff('contaud5');blendoff('contaud6');blendoff('contaud7');blendoff('contaud8');blendoff('contenido0'); blendoff('contenido1');blendoff('contenido2');blendoff('contenido3'); blendoff('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); blendoff('report01') ;"  onclick="return false;" >Seguimiento y accion</a></div-->
    </div>
</div>
</div>
...
<div class="dropMenu" >
<div class="subMenu" style="display:none;">
    <div class="subItem"><a href="#" onmouseover="visible('contmant0'); blendoff('contmant1'); blendoff('contmant2'); blendoff('contmant3');  blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); oculta('contaud0'); oculta('contaud1');  oculta('contaud2'); oculta('contaud3'); blendoff('report00'); blendoff('report01');" onclick="return false;" >USUARIO</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contmant1'); blendoff('contmant0'); blendoff('contmant2'); blendoff('contmant3');  blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); oculta('contaud0'); oculta('contaud1');  oculta('contaud2'); oculta('contaud3'); oculta('report01'); blendoff('report00');"  onclick="return false;" >PROVEEDORES</a></div>
    <div class="subItem"><a href="#" onmouseover="visible('contmant2'); blendoff('contmant1'); blendoff('contmant3'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('report00'); blendoff('report01'); "click="return false;" >FACTURAS</a></div>
    <!--div class="subItem"><a href="#" onmouseover="visible('contmant3'); blendoff('contmant1'); blendoff('contmant2'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('report00'); blendoff('report01'); " onclick="return false;">Disponble</a></div-->
...
<div class="dropMenu" ><!-- -->
 ...
 <div class="subItem"><a href="#" onmouseover="visible('procesar0'); oculta('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contenido0'); blendoff('contenido1'); oculta('contenido2'); oculta('contenido3');oculta('contenido4');oculta('report00'); blendoff('contmant0');blendoff('contmant1'); blendoff('report00'); blendoff('report01');" onclick="return false;" >FACTURA/PROV.</a></div>
...
<div class="dropMenu" >
	<div class="subMenu" style="display:none;">
		<div class="subItem"><a href="#" onmouseover="visible('report01'); oculta('report00'); oculta('report02'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2');blendoff('contenido3');blendoff('contenido4'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4'); blendoff('contaud5'); blendoff('contaud6'); blendoff('contaud7'); blendoff('contaud8'); blendoff('contaud9'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contenido4');" onclick="return false;" >Facturas1</a></div>
		<div class="subItem"><a href="#" onmouseover="visible('report02'); oculta('report00');oculta('report01'); blendoff('contaud0'); blendoff('contaud1'); blendoff('contaud2'); blendoff('contaud3'); blendoff('contaud4'); blendoff('contaud5'); blendoff('contaud6'); blendoff('contaud7'); blendoff('contaud8'); blendoff('contaud9'); blendoff('contenido0'); blendoff('contenido1'); blendoff('contenido2'); blendoff('contenido3'); blendoff('contenido4');" onclick="return false;" >Facturas2</a></div>
		<!--div class="subItem"><a href="#">Tasa de Auditores</a></div>
		<div class="subItem"><a href="#">Listado por CIF/</a></div-->
        </div>
</div>
...
<div class="tabs">
	...
	<div id="countrydivcontainer" style="padding:5px;background:white; url(images/plateados.jpg) top left repeat-x;border-radius:10px 50px 10px 50px;width:90%; ">
...
<fieldset>
		...
		<li><a href="#" rel="#default" class="selected">Informacion</a></li>
   	            <li><a href="reg_provee.php" rel="countrycontainer" class="selected" >Registro Datos</a></li>
                <li><a href="cons_provee.php" rel="countrycontainer">Consulta</a></li>
                
	           
				
					</ul>
	<div id="divcontainer" style="padding:5px;background:white; url(images/plateado.jpg) top left repeat-x;border-radius:10px 50px 10px 50px;width:90%;height:100%; ">
    <p>Este módulo permite el registro de las Tablas básicas</p>
 </div>
</div>
...
<dl>
	<div id="tabs">
					<ul id="conttabs1" class="shadetabs" >
							<li><a href="#" rel="#default" class="selected">Informacion</a></li>
							<li><a href="reg_fact.php" rel="countrycontainer">Registro Facturas</a></li>
							<li><a href="cons_fact.php" rel="countrycontainer">Consulta</a></li>
		     
      
                            
                            
					</ul>
	<div id="divcontainer1" style="padding:5px;background:white; url(images/plateados.jpg) top left repeat-x;border-radius:10px 50px 10px 50px;width:75%;height:70%; ">
    <p>Este módulo permite el registro de las Tablas básicas</p>
 </div>
</div>
...
<fieldset>
         	...
         	<dl>
        	  ...
        	  <ul id="contmant01tabs" class="shadetabs" >
        	     <li><a href="#" rel="#default" class="selected">Información</a></li>
           	     <li><a href="buscar_provee.php" rel="countrycontainer">Proveedor</a></li>
...
<fieldset>
         <legend ><img src="images/PNG/Config.png" width="30px">Mant.Factura</legend>
          ...
          <dl>
            ...
            <ul id="contmant01tabs" class="shadetabs" >
               <li><a href="#" rel="#default" class="selected">Información</a></li>
                 <li><a href="cons_auditados.php" rel="countrycontainer">Proveedor</a></li>
                 <li><a href="reg_rol_audit.php" rel="countrycontainer">Disponible</a></li>
                 <!--li><a href="reg_unit_audit.php" rel="countrycontainer">Disponible</a></li>
             <li><a href="reg_cargo_audit.php" rel="countrycontainer">Disponible</a></li-->
...
<fieldset>
         <legend ><img src="images/PNG/Config.png" width="30px">Procesar Factura</legend>
          ...
          <dl>
              ...
              <div id="tabs">
            <ul id="procesar00tabs" class="shadetabs" >
               <li><a href="#" rel="#default" class="selected">Información</a></li>
                 <li><a href="buscar_procesar_fact.php" rel="countrycontainer">Buscar Factura</a></li>
                
            
                                      
            </ul>
          <div id="procesar00divcontainer" style="padding:5px;background:white; url(images/fondo_input/fondo_input2.png) top left repeat-x;border-radius:10px 50px 10px 50px;width:90%; ">
            <p>Este módulo permite el Realizar Mantenimiento, anular y actualizar informacion de los registros</p>
         </div>
        </div>
...
<script type="text/javascript">
var countries=new ddajaxtabs("countrytabs13", "countrydivcontainer13")
countries.setpersist(true)
countries.setselectedClassTarget("link") //"link" or "linkparent"
countries.init()
</script>
...
<script type="text/javascript">
var countries=new ddajaxtabs("report02tabs", "report02divcontainer")
countries.setpersist(true)
countries.setselectedClassTarget("link") //"link" or "linkparent"
countries.init()
</script>
<script type="text/javascript">
var countries=new ddajaxtabs("procesar00tabs", "procesar00divcontainer")
countries.setpersist(true)
countries.setselectedClassTarget("link") //"link" or "linkparent"
countries.init()
</script>
