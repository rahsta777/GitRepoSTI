...
/*if (mysql_num_rows(mysql_query("SELECT num_detalle FROM d001_programa_aud WHERE num_detalle	='" . $_GET["var1"] . "'", $link))==true) {*/
       ...
       <!---------------=================================================================================-------------------->         
    				            ...
    				            <input name="id_local" type="hidden" id="id_local" value="<?php echo $id;?>" />
									      <div id='basic-modal'>
                            <input  style="background:url(images/fondo_input/fondo_input_g.png);width:100px;height:30px ;" type="button"  name='basic' value='Actualizar1' class='basic'/>
                        </div>
                      
                        <!-- modal content -->
         <div id="basic-modal-content">
          
         <!--------------------------desde aqui contenido a mostrar------------------------------------------>
          <div class="cuadro_login" id="dato">
           <form action="acceso.php" method="POST" >
              <div  id="fila" >
                 <div   id="dato_login" align="center" ><img src="images/lock.png">
                      <div style="font-size:30px;" id="cabecera"><span class="header2">Datos de Acceso</span></div>
                 </div>
              </div>
               <hr>
         ...
         <!--------------------------fin contenido a mostrar------------------------------------------>
            ...
            <form action="elimreg_user.php" method="post" >
              ...
              <input  style="background:url(images/fondo_input/fondo_input_g.png);width:100px;height:30px ;" type="submit"  name='basic' value='facturas' class='basic'/>
              </form>
    				</td>
...
<!-- llamado a la libreria jQuery, para la ventana SimpleModal and Basic JS files -->
