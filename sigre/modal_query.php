...
<!---------------------------- modal input -------------------------------->
	...
	<div id='content'>
		<div id='basic-modal'>
                         ...
                         <td height="20" align="center" colspan="4" ><a HREF='#' onClick="javascript:window.close(self)" style="background:url(images/fondo_input/fondo_input_g.png);width:100px;height:30px ;">SAlir</a></td>
	</div><!--fin content-->
 <!---------------------------- modal content -------------------------------->
