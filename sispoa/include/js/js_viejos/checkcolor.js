...
function query_ajax_prove_fact()
 {
            var var13=(document.getElementById("buscarprov13").value);
    ...
    xmlhttp.onreadystatechange=function()
        ...
        if (xmlhttp.readyState==4 && xmlhttp.status==200)
          {
          document.getElementById("la_consulta13").innerHTML=xmlhttp.responseText;
          }
        }
    xmlhttp.open("GET","localizar_procesar_fact_lab.php?var13="+var13,true);
    xmlhttp.send();
    }
  }
  /******************************************************************/
  function buscar_fact_idprove() {
        var  vid=document.getElementById("id_local").value;
        testar=patroncod.test(vcodigo);
        //alert("Test= ["+testar+"]")
        if(vid!="")
            alert("paso");
